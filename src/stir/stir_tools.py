...
def generate_segments_lists_stir_v2(nrings, max_segment):
    my_matrix_size = " "
    ...
    print("MY MATRIX SIZE:", my_matrix_size)
    print("MY MATRIX RING DIFFERENCE:", my_matrix_ring_difference)
...
def OSEM3D_recons(
    ...
    elif scannerParams.get("attenuation_mode") == 2:
        att_corr_str = (
            "Bin Normalisation type := From ProjData \n"
            + "Bin Normalisation From ProjData := \n"
            + "normalisation projdata filename:= "
